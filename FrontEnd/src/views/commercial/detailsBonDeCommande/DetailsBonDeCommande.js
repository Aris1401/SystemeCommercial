			...
			<CCardBody>
				...
				<CRow className='mt-2 text-end'>
					<CCol>
						...
						<p className='m-0 ' style={{ fontSize: '.9rem' }}>Arreter au montant de la somme de <b>{bonDeCommande && bonDeCommande.totalPrixTTC}</b> Ar</p>
					</CCol>
				</CRow>

				<CRow className='mt-2'>
					<CButton disabled>Valider</CButton>
				</CRow>
			</CCardBody>
		</CCard>
	)
