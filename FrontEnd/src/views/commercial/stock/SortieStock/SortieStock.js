...
export var sortirStock = (data) => {
    return new Promise((resolve, reject) => {
        makeRequest({
            url: '/etatdestock/sortie',
            requestType: 'POST',
            values: data,
    ...
    <CCard>
        ...
        <CCardBody>
            <CForm className='d-flex flex-column gap-3' onSubmit={handleAjoutSubmit}>
                ...
                <CRow>
                    <CCol>
                        <CButton color='primary' type='sumbit' size='lg'>Sortir</CButton>
                    </CCol>
                </CRow>
            </CForm>
        </CCardBody>
